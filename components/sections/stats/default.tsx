  ...
  items = [
    {
      label: "Tasks Managed",
      value: 2500,
      description: "Tasks organized across all user projects",
    },
    {
    ...
    },
    {
      label: "Notes Created",
      value: 12000,
      description: "Ideas and knowledge captured in notes",
    },
    {
      label: "Users Onboarded",
      value: 1500,
      description: "Users building their second brain daily",
    },
  ],
  className,
}: StatsProps) {
